@extends('layouts.web')
@section('titulo', 'Inscripcion Estudiante | Simulacro')
@section('css')
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="float-left">
                                                        <h5>INSCRIPCIÓN DE ESTUDIANTES SIMULACRO</h5>
                                                    </div>
                                                    <div class="float-right">
                                                        Fecha: {{ date('d-m-Y') }}
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-xs-12">
                                                    @if (now() >= $configuracion->inicio && now() < $configuracion->fin )
                                                        <w-simulacro-inscripcion-estudiante :estudiante="{{ $estudiante }}"></w-simulacro-inscripcion-estudiante>
                                                        @else
                                                        ...
                                                        @if (Auth::check())
                                                        <w-simulacro-inscripcion-estudiante :estudiante="{{ $estudiante }}">
                                                        </w-simulacro-inscripcion-estudiante>
                                                        @else
                                                        <div class="alert alert-warning" role="alert">
                                                            <p>Cualquier
