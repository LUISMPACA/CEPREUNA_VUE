@extends('layouts.web')
@section('titulo', 'Validación | CepreUNA')
@section('css')
...
<div class="contenido mt-5">
    <div class="card">
        ...
        <div class="card-body text-left">
            <form method="POST" action="{{ route('logindisponibilidad') }}">
                @csrf
                ...
                <div class="password-container">
                    <input type="password" class="form-control" name="password" id="password" placeholder="Ingrese contraseña (DNI)" required>
