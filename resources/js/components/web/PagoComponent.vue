                                    ...
                                    <form class="" action="" @submit.prevent="submit">
                                        <div class="form-row">
                                            <div class="alert alert-info text-justify" role="alert">
                                                <small class=""><i class="fa fa-info-circle"></i> Para validar el pago debe
                                                    transcurrir un día para iniciar su inscripción ó <b>realizar el pago con
                                                        un día de anticipación</b></small>
                                            </div>
                                            <div class="alert alert-warning text-justify" role="alert">
                                                <small class=""><i class="fa fa-info-circle"></i><b> Usted realizo el pago mediante
                                                    <a href="https://pagalo.pe/">pagalo.pe</a></b>
                                        ...
                                        <div class="form-row" style="margin: 5px 0;">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                <input type="text" v-model="fields.secuencia" name="secuencia"
                                                    id="secuencia" class="form-control" placeholder="">
                                                <div v-if="errors && errors.secuencia" class="text-danger">{{
                                                    errors.secuencia[0] }}</div>
                                            </div>
                                        </div>
                                        <div class="form-row" style="margin: 5px 0;">
                                            <label class="col-md-5 col-xs-12 control-label"> Monto: </label>
                                            <div class="col-md-7 col-xs-12">
                                                <input type="text" v-model="fields.monto" name="monto" id="monto"
                                                    class="form-control">
                                                <div v-if="errors && errors.monto" class="text-danger">{{ errors.monto[0] }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row" style="margin: 5px 0;">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                <input type="date" v-model="fields.fecha" name="fecha" id="fecha"
                                                    min="2020-08-03" class="form-control">
                                                <div v-if="errors && errors.fecha" class="text-danger">{{ errors.fecha[0] }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-7 col-xs-12 ">
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" id="adjunto" name="adjunto" @change="filesChange"
                                                            class="custom-file-input ">
                                                        <label class="custom-file-label" for="exampleInputFile">{{
                                                            selectAdjunto.substr(0, 20) }}...</label>
                                                    </div>
                                                </div>
                                                <div v-if="errors && errors.file" class="text-danger">{{ errors.file[0] }}
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" id="validar-banco" class="btn btn-primary">Validar
                                                pago</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <img src="/images/voucher.jpg" class="img-fluid image-responsive image-with-margin" alt="" >
                                </div>
                            </div>
                        </div>
                    </div>
