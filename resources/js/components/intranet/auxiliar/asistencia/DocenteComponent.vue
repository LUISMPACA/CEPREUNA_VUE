                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" min="1" max="3" onkeydown="return false;" class="form-control" id="horas_asistidas" v-model="fields.horas_asistidas" />
...
export default {
    ...
    data() {
        return {
            errors: {},
            fields: { estado: 1, sesion: "", observacion: "", cantidad_estudiantes: "", imagen: null,horas_asistidas:1,modalidad:"",fecha_tema:"",tema:"" },
            url: "",
            urlParte: "",
            area: "",
            turno: "",
